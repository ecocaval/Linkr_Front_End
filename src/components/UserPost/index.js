			...
			<PostArea data-test="post">
				...
				<Right>
					<Infos>
						<Header>
							...
							<Icons>
								{post.userCanDeletePost && (
									<>
										<IoPencilSharp className="icon" data-test="edit-btn" />
										<IoTrashSharp
											className="icon"
											onClick={() => {
						...
						<div className="description" data-test="description">
							{post.postDesc}
						</div>
						<LinkArea data-test="link" href={post.linkData.url} target="_blank">
							<div className="left">
								<div className="title">{post.linkData.title}</div>
								<div className="subtitle">{post.linkData.description}</div>
								<div className="link">{post.linkData.url}</div>
							</div>
							<div className="right">
